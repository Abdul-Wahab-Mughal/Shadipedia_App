...
public class User_Forget_Password extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobile = findViewById(R.id.forgetmobilenumber);
        pass = findViewById(R.id.forgetpass);
        submit = findViewById(R.id.Submitforgetuser);
        submitpass = findViewById(R.id.Submitforgetuserpass);
        ...
        submit.setOnClickListener(v -> {
            ...
            if (e.matches(emailPattern)) {
                ...
                Thread thread = new Thread(() -> firestore.collection("users").whereEqualTo("email", e).get()
